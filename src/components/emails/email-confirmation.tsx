...
export function EmailConfirmation({ confirmationLink, userEmail }: EmailConfirmationProps) {
  return `
<!DOCTYPE html>
<html lang="en">
<head>
  ...
  <title>Confirm Your Email - Finance Academy</title>
</head>
        ...
        <table role="presentation" style="width: 600px; border-collapse: collapse; background-color: #ffffff; border-radius: 8px; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">
          ...
          <tr>
            <td style="padding: 40px;">
              <h2 style="margin: 0 0 20px 0; color: #1a1a1a; font-size: 24px; font-weight: 600;">Confirm Your Email Address</h2>
              
              <p style="margin: 0 0 20px 0; color: #4a5568; font-size: 16px; line-height: 1.6;">
                Thanks for signing up! Please confirm your email address <strong>${userEmail}</strong> to get started with Finance Academy.
              </p>
              ...
              <table role="presentation" style="margin: 0 auto;">
                <tr>
                  <td style="border-radius: 6px; background: linear-gradient(135deg, #55cf9e 0%, #3da87a 100%);">
                    <a href="${confirmationLink}" target="_blank" style="display: inline-block; padding: 16px 40px; color: #ffffff; text-decoration: none; font-size: 16px; font-weight: 600; border-radius: 6px;">
                      Confirm Email
                    </a>
                  </td>
                </tr>
              ...
              <div style="margin-top: 30px; padding-top: 30px; border-top: 1px solid #e2e8f0;">
                <p style="margin: 0; color: #718096; font-size: 14px; line-height: 1.6;">
                  If you didn't create an account with Finance Academy, you can safely ignore this email.
                </p>
              </div>
            </td>
          </tr>
